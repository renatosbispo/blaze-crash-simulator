...
function getEntrySignalStats(entrySignal) {
  ...
  const entrySignalPredictionProbabilityStandardDeviation = standardDeviation(
    entrySignalPredictionProbabilities
  );
  ...
  const entrySignalCountPercentageStandardDeviation = standardDeviation(
...
printEntrySignalStats([0, 0, 0, 0, 0, 0]);
printEntrySignalStats([0, 0, 0, 0, 0, 0, 0]);
printEntrySignalStats([0, 0, 0, 0, 1, 1]);
